...
namespace _161003___Homework___CRUD
{
    public partial class FormSil : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            SqlHelper.cnn.Close();
                SqlCommand cmd = new SqlCommand();
                cmd.CommandText = string.Format("DELETE FROM Products WHERE ProductID={0}",txtProdIuctID.Text
                    );
                ...
                try
                {
                    ...
                    {
                        MessageBox.Show("silme işleminde bir hata olustu..");
                    }
